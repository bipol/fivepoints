...
func request_ScheduleService_GetArrivalEstimates_0(ctx context.Context, marshaler runtime.Marshaler, client ScheduleServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetArrivalEstimatesRequest
	...
	msg, err := client.GetArrivalEstimates(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterScheduleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ScheduleServiceClient) error {
	...
	mux.Handle("POST", pattern_ScheduleService_GetArrivalEstimates_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ScheduleService_GetArrivalEstimates_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_ScheduleService_GetArrivalEstimates_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ScheduleService_GetArrivalEstimates_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "get-arrival-estimates"}, ""))
)

var (
	forward_ScheduleService_GetArrivalEstimates_0 = runtime.ForwardResponseMessage
)
